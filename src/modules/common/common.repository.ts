...
export class CommonRepository<Model> extends Repository<Model> {
  async paginate(
    ...
    return paginate<Model>(this, options, searchOptions);
  }

  paginateCursor = async (
    options: FindConditions<Model> | FindManyOptions<Model>,
  ...
  async parsePaginate(
    ...
    options?: IPaginationOptions,
  ): Promise<CustomPagination<Model>> {
